...
struct colorNode* insert(struct colorNode* ,struct colorNode* ,int );
...
struct colorNode* del(struct colorNode* ,struct colorNode* ,int );
void del_fix_up(struct colorNode* ,struct colorNode* );
